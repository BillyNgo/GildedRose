...
Pretty simple. Well, this is where it gets interesting:
...
Feel free to make any changes to the UpdateQuality method or add any new code as long as everything still works correctly and you feel it works better. 
Just for clarification, an item can never have its Quality increase above 50, however "Sulfuras" is a legendary item, and as such its Quality is 80 and it never alters.

No need to care about data persistence.
